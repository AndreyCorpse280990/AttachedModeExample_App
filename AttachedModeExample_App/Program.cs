using AttachedModeExample_App.Mock;
using AttachedModeExample_App.Model;
using AttachedModeExample_App.Rdb;
using System;
...
namespace AttachedModeExample_App
{
    internal class Program
    {
        ...
        static void Test_IStudentRepository_Add(IStudentsRepository repository)
        {
            ...
            decimal? grants = grantsStr == null ? (decimal?)null : Convert.ToDecimal(grantsStr);
        ...
        static void Main(string[] args)
        {
            ...
            // using (IStudentsRepository repository = new RdbStudentsRepository())
            {
                while (true)
                {
